...
<div class="pageTitle">
    <h2>{$lblAlacarte|ucfirst}: {$lblEdit}</h2>
</div>
...
{form:edit}
    ...
    <div class="fullwidthOptions">
        <a href="{$var|geturl:'deleteAlacarte'}&amp;id={$item.id}" data-message-id="confirmDelete" class="askConfirmation button linkButton icon iconDelete">
